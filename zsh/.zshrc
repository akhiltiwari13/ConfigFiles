...
[ -d /Library/Ruby/Gems/2.6.0/bin ] && export PATH="/Library/Ruby/Gems/2.6.0/bin:$PATH"
...
__conda_setup="$('/Users/akhil/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/akhil/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/akhil/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/akhil/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Created by `pipx` on 2025-06-03 22:33:33
export PATH="$PATH:/Users/akhil/.local/bin"
